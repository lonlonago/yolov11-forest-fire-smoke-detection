# YOLOv11 Forest Fire Smoke Detection

## Body

YOLOv11 Forest Fire Smoke Detection System Based on Deep Learning YOLOv11 (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 2 classes, 
name: ['fire', 'smoke'], 
dataset quantity: training set 2083 images, validation set 260 images, test set 261 images.
